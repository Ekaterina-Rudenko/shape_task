...
public class CentreXComparatorTest {
    CentreXComparator comparatorCentreX;

    @BeforeMethod
    public void create() {
        comparatorCentreX = new CentreXComparator();
    }
    ...
    public Object[][] coneData() {
        ...
        coneList.add(new Cone(new Point(1.0, 2.0, 1.0), new Point(1.0, 2.0, 5.0), 4.0));
        coneList.add(new Cone(new Point(3.0, 4.0, 1.0), new Point(3.0, 4.0, 10.0), 14.0));
    ...
    public void centreXComparatorEqualTest(List<Cone> cone, List<Integer> expected) {
        int actual = comparatorCentreX.compare(cone.get(0), cone.get(1));
        Assert.assertEquals(actual, (int) expected.get(0));
    }

    @Test(dataProvider = "conesToCompare")
    public void centreXComparatorTest(List<Cone> cone, List<Integer> expected) {
        int actual = comparatorCentreX.compare(cone.get(0), cone.get(2));
