...
public class HeightComparator implements Comparator<Cone> {
    public int compare(Cone o1, Cone o2){
        double height1 = Math.abs(o1.getApexPoint().getZ())-Math.abs(o1.getCentrePoint().getZ());
        double height2 = Math.abs(o2.getApexPoint().getZ())-Math.abs(o2.getCentrePoint().getZ());
